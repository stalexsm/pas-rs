        ...
        <nav class="bg-gray-800">
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="relative ml-3">
                    ...
                    <button
                        {onclick}
                        type="button" class="text-gray-300 relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                        id="user-menu-button"
